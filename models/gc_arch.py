...
#Condition vector/ Global predictor
...
#位置编码通常被添加到输入数据中，以提供关于输入数据中元素的相对位置信息
...
class GlobalCorrector(nn.Module):
    def __init__(self, in_nc=3, out_nc=3, base_nf=64, cond_nf=32, act_type='relu', normal01=False):
        ...
        self.cond_net = Condition(in_nc=in_nc, nf=cond_nf) #Condition vector
